...
<head>
  ...
  <style nonce="${opts.nonce}">${LW_CSS}</style>
</head>
<body>
${opts.body}
...
export const LW_MARK_SVG = `<svg class="logo" width="16" height="16" viewBox="0 0 32 32" aria-hidden="true" fill="none">
...
export const LW_MARK_SVG_LG = `<svg width="56" height="56" viewBox="0 0 32 32" aria-hidden="true" fill="none">
