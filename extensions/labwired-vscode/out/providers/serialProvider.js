...
exports.SerialViewProvider = void 0;
...
class SerialViewProvider {
    ...
    view;
    editorWebview;
    tabs = [{ id: "t1", port: "", baud: 115200, log: "" }];
    activeId = "t1";
    ...
    openInEditor() {
        const panel = vscode.window.createWebviewPanel("labwired.serial.editor", "LabWired Monitor", vscode.ViewColumn.Beside, { enableScripts: true, retainContextWhenHidden: true });
        this.editorWebview = panel.webview;
        panel.webview.html = this.html();
        panel.webview.onDidReceiveMessage((msg) => void this.onMessage(msg));
        panel.onDidDispose(() => {
            if (this.editorWebview === panel.webview)
        ...
        switch (msg.type) {
            ...
            case "refreshPorts": {
                ...
                post({
                    type: "state",
                    ports,
                    baud: vscode.workspace
                        .getConfiguration("labwired")
                        .get("defaultBaud") || 115200,
                    tabs: this.tabs,
                    activeId: this.activeId,
                    live,
...
exports.SerialViewProvider = SerialViewProvider;
function getNonce() {
...
//# sourceMappingURL=serialProvider.js.map