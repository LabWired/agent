...
exports.OverviewViewProvider = void 0;
/**
...
class OverviewViewProvider {
    ...
    bridge;
    catalog;
    static viewType = "labwired.overview";
    view;
    editor;
    serialTail = "";
    series = { uart: [] };
    ...
    openInEditor() {
        ...
        const panel = vscode.window.createWebviewPanel("labwired.overview.editor", "LabWired Overview", vscode.ViewColumn.Beside, { enableScripts: true, retainContextWhenHidden: true });
        this.editor = panel;
    ...
    pushSample(n, series = "uart") {
        const arr = this.series[series] || (this.series[series] = []);
        arr.push(n);
        if (arr.length > 400)
            this.series[series] = arr.slice(-400);
        void this.pushState();
    }
    setEvidence(ev) {
        this.evidence = ev;
    ...
    async onMessage(msg) {
        ...
        if (msg.type === "openPlayground") {
            await vscode.env.openExternal(vscode.Uri.parse("https://app.labwired.com"));
            return;
        }
...
exports.OverviewViewProvider = OverviewViewProvider;
function getNonce() {
